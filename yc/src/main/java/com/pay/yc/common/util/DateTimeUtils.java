...
public final class DateTimeUtils {
    ...
    public static void main(String[] argvs) {
    	...
    	System.out.println(parseDateFromString("130101", HHMMSS));
    ...
    /** Formatter with: YYYYMMDDHHMMSS **/
    public final static int YYYYMMDDHHMMSS = 7;
    /** Formatter with: YYYYMMDDHHMMSS **/
    public final static int YYYYMMDD = 8;
    /** Formatter with: YYYYMMDDHHMMSS **/
    public final static int HHMMSS = 9;
    public final static int YYYYMMDDHHMMSSSS = 10;
    ...
    private final static SimpleDateFormat[] DATE_FORMATTER = new SimpleDateFormat[] {
            new SimpleDateFormat("MMM d, yyy"),
     ...
     * @return the formatted date
     */
    public final static Date parseDateFromString(String val, int format) {
        Date rel = null;
        if (val != null) {
            if (format >= DATE_FORMATTER.length || format < 0) {
                format = 0;
            ...
            try {
				rel = DATE_FORMATTER[format].parse(val);
