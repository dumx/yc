package com.pay.yc.common.repository;
...
public class Searchable {
    ...
    public Date getDateValue(final Long key) {
        final Object value = this.params.get(key);
        if (value == null) {
            return null;
        }
    ...
    public String toQueryString() {
        ...
        this.params.entrySet().stream().forEach(entry -> {
            ...
            str.append("s_").append(entry.getKey()).append("=").append(entry.getValue());
        });
        return str.toString();
    }
}
